...
- **Email fallback** for the minority of clients not reachable on WhatsApp. Still open — needs an email provider decision (no SMTP/transactional-email integration exists in this codebase yet), similar in kind to the digest channel tradeoff above.
