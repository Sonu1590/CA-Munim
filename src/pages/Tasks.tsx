...
export { taskTypeGroups, dueDateRules, financialYears, quarters, months } from "@/data/Tasks";
    ...
    <AppLayout>
      <div className="p-4 md:p-6 space-y-4">
        ...
        <div className="hidden md:flex md:items-center justify-between gap-3" data-testid="desktop-tasks-header">
          <div>
            <h1 className="text-xl md:text-2xl font-heading font-medium text-foreground">
              Tasks & Deadlines
            </h1>
